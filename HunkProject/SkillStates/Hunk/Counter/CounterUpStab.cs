...
{
    public class CounterUpStab : BaseHunkSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            base.PlayAnimation("FullBody, Override", "CounterUpStab", "Dodge.playbackRate", this.duration);
            ...
            this.desiredPos = this.targetPos + (this.lookVector * 2.4f);
        ...
        public override void FixedUpdate()
        {
            ...
            if (this.target && base.isAuthority && !(base.fixedAge >= 0.64f * this.duration))
            {
            ...
            if (!this.hasStabbed == base.fixedAge >= (0.11f * this.duration))
            {
                ...
                if (this.target)
                {
                    ...
                    if (base.isAuthority)
                    {
                        ...
                        blastAttack.baseDamage = this.damageStat * 10f;
            ...
            if (!this.hasSnapped && base.fixedAge >= 0.64f * this.duration)
            {

...
{
    public class TemplarExplosion : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            this.headTransform = this.transform.Find("ClayBruiserArmature/ROOT/base/stomach");

            if (this.headTransform)
            {
                EffectManager.SpawnEffect(Modules.Assets.tarExplosion, new EffectData
                {
                ...
                //GameObject.Instantiate(Modules.Assets.tarExplosion, this.headTransform);

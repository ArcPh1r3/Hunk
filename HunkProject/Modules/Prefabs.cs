...
namespace HunkMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        internal static void RegisterNewSurvivor(GameObject bodyPrefab, GameObject displayPrefab, string namePrefix, UnlockableDef unlockableDef)
        {
            ...
            string fullOutroString = MainPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = MainPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        internal static GameObject CreateDisplayPrefab(string modelName, GameObject prefab)
        {
            ...
            model.AddComponent<Modules.Components.HunkCSS>();
        ...
        private static Transform SetupModel(GameObject prefab, Transform modelTransform)
        {
            ...
            modelTransform.localScale = Vector3.one * 24f;//new Vector3(0.55f, 0.55f, 0.55f);
        ...
        {
            MainPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            MainPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            MainPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
